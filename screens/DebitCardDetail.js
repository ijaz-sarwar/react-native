  ...
  return (
    ...
    <Appbar.Action icon="dots-vertical"  />
        ...
        <Text style={{top:10,alignSelf:'center',fontWeight:'bold',color:'skyblue'}}>Cards</Text>
          ...
          <View style={{top:30,alignSelf:'center',backgroundColor:'blue',height:40,width:'85%',borderRadius:20,}}>
          <TouchableOpacity onPress={()=> {navigation.navigate('DebitCardInputInfo')}} style={{height:'100%',width:'100%',alignItems:'center',justifyContent:'center'}}>
      ...
      <Text style={{padding:10,fontWeight:'bold',alignSelf:'center',color:'darkblue'}}>Last Transactions</Text>
          ...
          <View style={{padding:1}}>
             ...
             <View style={{padding:1}}>
              ...
              <Text style={{textAlign:'right',bottom:20,color:'pink'}}>-124.99€</Text>
              <Text>13 April 2017  12:51</Text>
